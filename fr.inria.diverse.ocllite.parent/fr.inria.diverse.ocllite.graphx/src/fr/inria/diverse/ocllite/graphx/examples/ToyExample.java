package fr.inria.diverse.ocllite.graphx.examples;
...
public final class ToyExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    JavaSparkContext ctx = new JavaSparkContext(args[0], "ToyExample",
      System.getenv("SPARK_HOME"), JavaSparkContext.jarOfClass(ToyExample.class));
