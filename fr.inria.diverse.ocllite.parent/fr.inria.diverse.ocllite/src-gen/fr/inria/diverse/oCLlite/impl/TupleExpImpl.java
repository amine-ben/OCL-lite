 ...
 * </p>
 * <ul>
 *   <li>{@link fr.inria.diverse.oCLlite.impl.TupleExpImpl#getParts <em>Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleExpImpl extends OclLExpressionImpl implements TupleExp
{
  /**
  ...
  {
    return OCLlitePackage.Literals.TUPLE_EXP;
  }
  ...
  public EList<TuplePart> getParts()
  {
    if (parts == null)
    {
      parts = new EObjectContainmentEList<TuplePart>(TuplePart.class, this, OCLlitePackage.TUPLE_EXP__PARTS);
    }
    return parts;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case OCLlitePackage.TUPLE_EXP__PARTS:
